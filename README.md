...
Built an AI Assistant as VS code extension that performs security audit of the code using local LLM models (ollama llama3.1). The user can enter code into a file and the extension runs it through a prompt to check and highlight for security issues.
